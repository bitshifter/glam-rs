...
## [0.33.5](https://github.com/bitshifter/glam-rs/compare/0.33.4...0.33.5) - 2026-08-18

### Other

- update CONTRIBUTING.md and ARCHITECTURE.md ([#779](https://github.com/bitshifter/glam-rs/pull/779))
- exempt release-plz PRs from the title lint and fix the bump policy docs ([#777](https://github.com/bitshifter/glam-rs/pull/777))
