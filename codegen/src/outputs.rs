...
pub fn build_output_pairs() -> HashMap<&'static str, tera::Context> {
    HashMap::from([
        ...
        (
            "src/swizzles/neon/vec4a_impl.rs",
        ...
        (
            "src/f32/neon/vec4a.rs",
            ContextBuilder::new_vec4a().target_neon().build(),
        ),
        (
        ...
        (
            "src/f32/neon/quata.rs",
            ContextBuilder::new_quata().target_neon().build(),
        ),
        (
        ...
        (
            "src/f32/neon/mat2a.rs",
            ContextBuilder::new_mat2a().target_neon().build(),
        ),
        (
        ...
        (
            "src/f32/neon/mat4a.rs",
            ContextBuilder::new_mat4a().target_neon().build(),
        ),
        (
