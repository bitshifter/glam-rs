...
use glam::Vec3;
use std::ops::{Add, Mul};
use support::{random_mat3, random_quat, random_srt_mat3x4, random_srt_mat4, random_vec3};
...
bench_binop!(
    mat3x4_transform_point3,
    "mat3x4 transform point3",
    op => transform_point3,
    from1 => random_srt_mat3x4,
    from2 => random_vec3
);

bench_binop!(
    mat3x4_transform_vector3,
    "mat3x4 transform vector3",
