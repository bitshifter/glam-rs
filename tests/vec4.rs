...
mod vec4 {
    ...
    glam_test!(test_as, {
        use glam::{
            DVec4, I16Vec4, I64Vec4, I8Vec4, IVec4, U16Vec4, U64Vec4, U8Vec4, USizeVec4, UVec4,
            Vec4,
        };
        assert_eq!(
...
mod uvec4 {
    use glam::{
        uvec4, BVec4, I16Vec4, I64Vec4, I8Vec4, IVec4, U16Vec4, U64Vec4, U8Vec4, USizeVec4, UVec2,
        UVec3, UVec4,
    };
