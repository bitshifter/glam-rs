...
```toml
[dependencies]
glam = { version = "0.30.6", default-features = false, features = ["libm"] }
```
...
[dependencies]
glam = { version = "0.30.6", default-features = false }
```
...
[dependencies]
glam = { version = "0.30.6", default-features = false, features = ["nostd-libm"] }
```
