...
impl BitAndAssign for U8Vec4 {
    #[inline]
    fn bitand_assign(&mut self, rhs: U8Vec4) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&U8Vec4> for U8Vec4 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &U8Vec4) {
...
impl BitOrAssign for U8Vec4 {
    #[inline]
    fn bitor_assign(&mut self, rhs: U8Vec4) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&U8Vec4> for U8Vec4 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &U8Vec4) {
...
impl BitXorAssign for U8Vec4 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: U8Vec4) {
...
impl Shl<&crate::IVec4> for U8Vec4 {
    type Output = U8Vec4;
    #[inline]
    fn shl(self, rhs: &crate::IVec4) -> U8Vec4 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec4> for U8Vec4 {
    type Output = U8Vec4;
    #[inline]
    fn shr(self, rhs: &crate::IVec4) -> U8Vec4 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec4> for U8Vec4 {
    type Output = U8Vec4;
    #[inline]
    fn shl(self, rhs: &crate::UVec4) -> U8Vec4 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec4> for U8Vec4 {
    type Output = U8Vec4;
    #[inline]
    fn shr(self, rhs: &crate::UVec4) -> U8Vec4 {
        self.shr(*rhs)
    }
}
