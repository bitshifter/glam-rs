...
impl BitAndAssign for U8Vec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: U8Vec3) {
...
impl BitOrAssign for U8Vec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: U8Vec3) {
        *self = self.bitor(rhs);
    }
}
...
impl BitXorAssign for U8Vec3 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: U8Vec3) {
...
impl Shl<&crate::IVec3> for U8Vec3 {
    type Output = U8Vec3;
    #[inline]
    fn shl(self, rhs: &crate::IVec3) -> U8Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec3> for U8Vec3 {
    type Output = U8Vec3;
    #[inline]
    fn shr(self, rhs: &crate::IVec3) -> U8Vec3 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec3> for U8Vec3 {
    type Output = U8Vec3;
    #[inline]
    fn shl(self, rhs: &crate::UVec3) -> U8Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec3> for U8Vec3 {
    type Output = U8Vec3;
    #[inline]
    fn shr(self, rhs: &crate::UVec3) -> U8Vec3 {
        self.shr(*rhs)
    }
}
