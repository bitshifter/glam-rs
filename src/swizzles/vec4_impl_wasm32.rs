...
impl Vec4Swizzles for Vec4 {
    ...
    #[inline]
    fn xw(self) -> Vec2 {
        Vec2(i32x4_shuffle::<0, 3, 4, 4>(self.0, self.0).into())
    }
    ...
    #[inline]
    fn yw(self) -> Vec2 {
        Vec2(i32x4_shuffle::<1, 3, 4, 4>(self.0, self.0).into())
    }
    ...
    #[inline]
    fn zw(self) -> Vec2 {
        Vec2(i32x4_shuffle::<2, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wx(self) -> Vec2 {
        Vec2(i32x4_shuffle::<3, 0, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wy(self) -> Vec2 {
        Vec2(i32x4_shuffle::<3, 1, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wz(self) -> Vec2 {
        Vec2(i32x4_shuffle::<3, 2, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn ww(self) -> Vec2 {
        Vec2(i32x4_shuffle::<3, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xxx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 0, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xxy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 0, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xxz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 0, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xxw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 0, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xyx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 1, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xyy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 1, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xyz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 1, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xyw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 1, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xzx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 2, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xzy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 2, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xzz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 2, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xzw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 2, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xwx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xwy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 3, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xwz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 3, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn xww(self) -> Vec3 {
        Vec3(i32x4_shuffle::<0, 3, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yxx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 0, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yxy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 0, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yxz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 0, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yxw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 0, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yyx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 1, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yyy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 1, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yyz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 1, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yyw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 1, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yzx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 2, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yzy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 2, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yzz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 2, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yzw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 2, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn ywx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn ywy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 3, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn ywz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 3, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn yww(self) -> Vec3 {
        Vec3(i32x4_shuffle::<1, 3, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zxx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 0, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zxy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 0, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zxz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 0, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zxw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 0, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zyx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 1, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zyy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 1, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zyz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 1, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zyw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 1, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zzx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 2, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zzy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 2, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zzz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 2, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zzw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 2, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zwx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zwy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 3, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zwz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 3, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn zww(self) -> Vec3 {
        Vec3(i32x4_shuffle::<2, 3, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wxx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 0, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wxy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 0, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wxz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 0, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wxw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 0, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wyx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 1, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wyy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 1, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wyz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 1, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wyw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 1, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wzx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 2, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wzy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 2, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wzz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 2, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wzw(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 2, 7, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wwx(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 3, 4, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wwy(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 3, 5, 4>(self.0, self.0).into())
    }

    #[inline]
    fn wwz(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 3, 6, 4>(self.0, self.0).into())
    }

    #[inline]
    fn www(self) -> Vec3 {
        Vec3(i32x4_shuffle::<3, 3, 7, 4>(self.0, self.0).into())
    }
