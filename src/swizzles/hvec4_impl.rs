...
use crate::{HVec2, HVec3, HVec4, Vec4Swizzles};

impl Vec4Swizzles for HVec4 {
    type Vec2 = HVec2;
    ...
    #[inline]
    fn with_xw(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn with_yw(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn with_zw(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn with_wx(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn with_wy(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn with_wz(self, rhs: HVec2) -> Self {
    ...
    #[inline]
    fn xxz(self) -> HVec3 {
        HVec3::new(self.x, self.x, self.z)
    }

    #[inline]
    fn xxw(self) -> HVec3 {
        HVec3::new(self.x, self.x, self.w)
    }
    ...
    #[inline]
    fn with_xyz(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, rhs.y, rhs.z, self.w)
    }

    #[inline]
    fn xyw(self) -> HVec3 {
        HVec3::new(self.x, self.y, self.w)
    }

    #[inline]
    fn with_xyw(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, rhs.y, self.z, rhs.z)
    }

    #[inline]
    fn xzx(self) -> HVec3 {
        HVec3::new(self.x, self.z, self.x)
    }

    #[inline]
    fn xzy(self) -> HVec3 {
        HVec3::new(self.x, self.z, self.y)
    }

    #[inline]
    fn with_xzy(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, rhs.z, rhs.y, self.w)
    }

    #[inline]
    fn xzz(self) -> HVec3 {
        HVec3::new(self.x, self.z, self.z)
    }

    #[inline]
    fn xzw(self) -> HVec3 {
        HVec3::new(self.x, self.z, self.w)
    }

    #[inline]
    fn with_xzw(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, self.y, rhs.y, rhs.z)
    }

    #[inline]
    fn xwx(self) -> HVec3 {
        HVec3::new(self.x, self.w, self.x)
    }

    #[inline]
    fn xwy(self) -> HVec3 {
        HVec3::new(self.x, self.w, self.y)
    }

    #[inline]
    fn with_xwy(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, rhs.z, self.z, rhs.y)
    }

    #[inline]
    fn xwz(self) -> HVec3 {
        HVec3::new(self.x, self.w, self.z)
    }

    #[inline]
    fn with_xwz(self, rhs: HVec3) -> Self {
        Self::new(rhs.x, self.y, rhs.z, rhs.y)
    }

    #[inline]
    fn xww(self) -> HVec3 {
        HVec3::new(self.x, self.w, self.w)
    }
    ...
    #[inline]
    fn yxz(self) -> HVec3 {
        HVec3::new(self.y, self.x, self.z)
    }

    #[inline]
    fn with_yxz(self, rhs: HVec3) -> Self {
        Self::new(rhs.y, rhs.x, rhs.z, self.w)
    }

    #[inline]
    fn yxw(self) -> HVec3 {
        HVec3::new(self.y, self.x, self.w)
    }

    #[inline]
    fn with_yxw(self, rhs: HVec3) -> Self {
    ...
    #[inline]
    fn yyz(self) -> HVec3 {
        HVec3::new(self.y, self.y, self.z)
    }

    #[inline]
    fn yyw(self) -> HVec3 {
        HVec3::new(self.y, self.y, self.w)
    }

    #[inline]
    fn yzx(self) -> HVec3 {
        HVec3::new(self.y, self.z, self.x)
    }

    #[inline]
    fn with_yzx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, rhs.x, rhs.y, self.w)
    }

    #[inline]
    fn yzy(self) -> HVec3 {
        HVec3::new(self.y, self.z, self.y)
    }

    #[inline]
    fn yzz(self) -> HVec3 {
        HVec3::new(self.y, self.z, self.z)
    }

    #[inline]
    fn yzw(self) -> HVec3 {
        HVec3::new(self.y, self.z, self.w)
    }

    #[inline]
    fn with_yzw(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.x, rhs.y, rhs.z)
    }

    #[inline]
    fn ywx(self) -> HVec3 {
        HVec3::new(self.y, self.w, self.x)
    }

    #[inline]
    fn with_ywx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, rhs.x, self.z, rhs.y)
    }

    #[inline]
    fn ywy(self) -> HVec3 {
        HVec3::new(self.y, self.w, self.y)
    }

    #[inline]
    fn ywz(self) -> HVec3 {
        HVec3::new(self.y, self.w, self.z)
    }

    #[inline]
    fn with_ywz(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.x, rhs.z, rhs.y)
    }

    #[inline]
    fn yww(self) -> HVec3 {
        HVec3::new(self.y, self.w, self.w)
    }

    #[inline]
    fn zxx(self) -> HVec3 {
        HVec3::new(self.z, self.x, self.x)
    }

    #[inline]
    fn zxy(self) -> HVec3 {
        HVec3::new(self.z, self.x, self.y)
    }

    #[inline]
    fn with_zxy(self, rhs: HVec3) -> Self {
        Self::new(rhs.y, rhs.z, rhs.x, self.w)
    }

    #[inline]
    fn zxz(self) -> HVec3 {
        HVec3::new(self.z, self.x, self.z)
    }

    #[inline]
    fn zxw(self) -> HVec3 {
        HVec3::new(self.z, self.x, self.w)
    }

    #[inline]
    fn with_zxw(self, rhs: HVec3) -> Self {
        Self::new(rhs.y, self.y, rhs.x, rhs.z)
    }

    #[inline]
    fn zyx(self) -> HVec3 {
        HVec3::new(self.z, self.y, self.x)
    }

    #[inline]
    fn with_zyx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, rhs.y, rhs.x, self.w)
    }

    #[inline]
    fn zyy(self) -> HVec3 {
        HVec3::new(self.z, self.y, self.y)
    }

    #[inline]
    fn zyz(self) -> HVec3 {
        HVec3::new(self.z, self.y, self.z)
    }

    #[inline]
    fn zyw(self) -> HVec3 {
        HVec3::new(self.z, self.y, self.w)
    }

    #[inline]
    fn with_zyw(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.y, rhs.x, rhs.z)
    }

    #[inline]
    fn zzx(self) -> HVec3 {
        HVec3::new(self.z, self.z, self.x)
    }

    #[inline]
    fn zzy(self) -> HVec3 {
        HVec3::new(self.z, self.z, self.y)
    }

    #[inline]
    fn zzz(self) -> HVec3 {
        HVec3::new(self.z, self.z, self.z)
    }

    #[inline]
    fn zzw(self) -> HVec3 {
        HVec3::new(self.z, self.z, self.w)
    }

    #[inline]
    fn zwx(self) -> HVec3 {
        HVec3::new(self.z, self.w, self.x)
    }

    #[inline]
    fn with_zwx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, self.y, rhs.x, rhs.y)
    }

    #[inline]
    fn zwy(self) -> HVec3 {
        HVec3::new(self.z, self.w, self.y)
    }

    #[inline]
    fn with_zwy(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.z, rhs.x, rhs.y)
    }

    #[inline]
    fn zwz(self) -> HVec3 {
        HVec3::new(self.z, self.w, self.z)
    }

    #[inline]
    fn zww(self) -> HVec3 {
        HVec3::new(self.z, self.w, self.w)
    }

    #[inline]
    fn wxx(self) -> HVec3 {
        HVec3::new(self.w, self.x, self.x)
    }

    #[inline]
    fn wxy(self) -> HVec3 {
        HVec3::new(self.w, self.x, self.y)
    }

    #[inline]
    fn with_wxy(self, rhs: HVec3) -> Self {
        Self::new(rhs.y, rhs.z, self.z, rhs.x)
    }

    #[inline]
    fn wxz(self) -> HVec3 {
        HVec3::new(self.w, self.x, self.z)
    }

    #[inline]
    fn with_wxz(self, rhs: HVec3) -> Self {
        Self::new(rhs.y, self.y, rhs.z, rhs.x)
    }

    #[inline]
    fn wxw(self) -> HVec3 {
        HVec3::new(self.w, self.x, self.w)
    }

    #[inline]
    fn wyx(self) -> HVec3 {
        HVec3::new(self.w, self.y, self.x)
    }

    #[inline]
    fn with_wyx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, rhs.y, self.z, rhs.x)
    }

    #[inline]
    fn wyy(self) -> HVec3 {
        HVec3::new(self.w, self.y, self.y)
    }

    #[inline]
    fn wyz(self) -> HVec3 {
        HVec3::new(self.w, self.y, self.z)
    }

    #[inline]
    fn with_wyz(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.y, rhs.z, rhs.x)
    }

    #[inline]
    fn wyw(self) -> HVec3 {
        HVec3::new(self.w, self.y, self.w)
    }

    #[inline]
    fn wzx(self) -> HVec3 {
        HVec3::new(self.w, self.z, self.x)
    }

    #[inline]
    fn with_wzx(self, rhs: HVec3) -> Self {
        Self::new(rhs.z, self.y, rhs.y, rhs.x)
    }

    #[inline]
    fn wzy(self) -> HVec3 {
        HVec3::new(self.w, self.z, self.y)
    }

    #[inline]
    fn with_wzy(self, rhs: HVec3) -> Self {
        Self::new(self.x, rhs.z, rhs.y, rhs.x)
    }

    #[inline]
    fn wzz(self) -> HVec3 {
        HVec3::new(self.w, self.z, self.z)
    }

    #[inline]
    fn wzw(self) -> HVec3 {
        HVec3::new(self.w, self.z, self.w)
    }

    #[inline]
    fn wwx(self) -> HVec3 {
        HVec3::new(self.w, self.w, self.x)
    }

    #[inline]
    fn wwy(self) -> HVec3 {
        HVec3::new(self.w, self.w, self.y)
    }

    #[inline]
    fn wwz(self) -> HVec3 {
        HVec3::new(self.w, self.w, self.z)
    }

    #[inline]
    fn www(self) -> HVec3 {
        HVec3::new(self.w, self.w, self.w)
    }
