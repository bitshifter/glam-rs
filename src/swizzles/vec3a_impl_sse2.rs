...
impl Vec3Swizzles for Vec3A {
    ...
    fn xxy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_00_00))
        }
    }
    #[inline]
    fn xxz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_00_00))
        }
    }
    #[inline]
    fn xyx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_01_00))
        }
    }
    #[inline]
    fn xyy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_01_00))
        }
    }
    #[inline]
    fn xzx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_10_00))
        }
    }
    #[inline]
    fn xzy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_10_00))
        }
    }
    #[inline]
    fn xzz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_10_00))
        }
    }
    #[inline]
    fn yxx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_00_01))
        }
    }
    #[inline]
    fn yxy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_00_01))
        }
    }
    #[inline]
    fn yxz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_00_01))
        }
    }
    #[inline]
    fn yyx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_01_01))
        }
    }
    #[inline]
    fn yyy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_01_01))
        }
    }
    #[inline]
    fn yyz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_01_01))
        }
    }
    #[inline]
    fn yzx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_10_01))
        }
    }
    #[inline]
    fn yzy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_10_01))
        }
    }
    #[inline]
    fn yzz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_10_01))
        }
    }
    #[inline]
    fn zxx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_00_10))
        }
    }
    #[inline]
    fn zxy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_00_10))
        }
    }
    #[inline]
    fn zxz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_00_10))
        }
    }
    #[inline]
    fn zyx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_01_10))
        }
    }
    #[inline]
    fn zyy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_01_10))
        }
    }
    #[inline]
    fn zyz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_01_10))
        }
    }
    #[inline]
    fn zzx(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_00_10_10))
        }
    }
    #[inline]
    fn zzy(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_01_10_10))
        }
    }
    #[inline]
    fn zzz(self) -> Self {
        unsafe {
            Self(_mm_shuffle_ps(self.0, self.0, 0b00_10_10_10))
        }
    }
    #[inline]
    fn xx(self) -> Vec2 {
