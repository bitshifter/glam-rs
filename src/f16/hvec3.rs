...
use crate::{f16::math, BVec3, BVec3A, FloatExt, HQuat, HVec2, HVec4};
...
#[inline(always)]
#[must_use]
pub const fn hvec3(x: f16, y: f16, z: f16) -> HVec3 {
    HVec3::new(x, y, z)
}
...
impl HVec3 {
    ...
    pub const X: Self = Self::new(f16::ONE, f16::ZERO, f16::ZERO);

    /// A unit vector pointing along the positive Y axis.
    pub const Y: Self = Self::new(f16::ZERO, f16::ONE, f16::ZERO);

    /// A unit vector pointing along the positive Z axis.
    pub const Z: Self = Self::new(f16::ZERO, f16::ZERO, f16::ONE);

    /// A unit vector pointing along the negative X axis.
    pub const NEG_X: Self = Self::new(f16::NEG_ONE, f16::ZERO, f16::ZERO);

    /// A unit vector pointing along the negative Y axis.
    pub const NEG_Y: Self = Self::new(f16::ZERO, f16::NEG_ONE, f16::ZERO);

    /// A unit vector pointing along the negative Z axis.
    pub const NEG_Z: Self = Self::new(f16::ZERO, f16::ZERO, f16::NEG_ONE);

    /// The unit axes.
    pub const AXES: [Self; 3] = [Self::X, Self::Y, Self::Z];

    /// HVec3 uses Rust Portable SIMD
    pub const USES_CORE_SIMD: bool = false;
    /// HVec3 uses Arm NEON
    pub const USES_NEON: bool = false;
    /// HVec3 uses scalar math
    pub const USES_SCALAR_MATH: bool = true;
    /// HVec3 uses Intel SSE2
    pub const USES_SSE2: bool = false;
    /// HVec3 uses WebAssembly 128-bit SIMD
    ...
    #[inline]
    #[must_use]
    pub const fn from_array(a: [f16; 3]) -> Self {
    ...
    #[inline]
    #[must_use]
    pub(crate) fn from_vec4(v: HVec4) -> Self {
        Self {
            x: v.x,
            y: v.y,
            z: v.z,
    ...
    #[inline]
    #[must_use]
    pub fn extend(self, w: f16) -> HVec4 {
        HVec4::new(self.x, self.y, self.z, w)
    }
    ...
    #[inline]
    #[must_use]
    pub fn from_homogeneous(v: HVec4) -> Self {
        glam_assert!(v.w != f16::ZERO);
    ...
    #[inline]
    #[must_use]
    pub fn with_z(mut self, z: f16) -> Self {
        self.z = z;
        self
    }
    ...
    #[inline]
    #[must_use]
    pub fn angle_to(self, rhs: Self, axis: Self) -> f16 {
    ...
    #[inline]
    #[must_use]
    pub fn rotate_x(self, angle: f16) -> Self {
    ...
    #[inline]
    #[must_use]
    pub fn rotate_y(self, angle: f16) -> Self {
        let (sina, cosa) = math::sin_cos(angle);
        Self::new(
    ...
    #[inline]
    #[must_use]
    pub fn rotate_z(self, angle: f16) -> Self {
        let (sina, cosa) = math::sin_cos(angle);
        Self::new(
    ...
    #[inline]
    #[must_use]
    pub fn rotate_axis(self, axis: Self, angle: f16) -> Self {
        HQuat::from_axis_angle(axis, angle) * self
    }
    ...
    pub fn rotate_towards(self, rhs: Self, max_angle: f16) -> Self {
        ...
        let angle = max_angle.clamp(angle_between - crate::f16::PI, angle_between);
        let axis = self
            .cross(rhs)
            .try_normalize()
    ...
    pub fn any_orthogonal_vector(self) -> Self {
        ...
        if math::abs(self.x) > math::abs(self.y) {
            Self::new(-self.z, f16::ZERO, self.x) // self.cross(Self::Y)
        } else {
            Self::new(f16::ZERO, self.z, -self.y) // self.cross(Self::X)
        }
    }
    ...
    #[inline]
    #[must_use]
    pub fn slerp(self, rhs: Self, s: f16) -> Self {
        ...
        if dot < f16::ZERO {
            ...
            let rotation = HQuat::from_axis_angle(axis, crate::f16::PI * s);
            // Interpolate vector lengths
            let result_length = self_length.lerp(rhs_length, s);
    ...
    pub fn as_vec3(self) -> crate::Vec3 {
        crate::Vec3::new(f32::from(self.x), f32::from(self.y), f32::from(self.z))
    }
    ...
    pub fn as_vec3a(self) -> crate::Vec3A {
        crate::Vec3A::new(f32::from(self.x), f32::from(self.y), f32::from(self.z))
    }
    ...
    pub fn as_usizevec3(self) -> crate::USizeVec3 {
        self.as_vec3().as_usizevec3()
    }
}

impl Default for HVec3 {
    #[inline(always)]
    fn default() -> Self {
        Self::ZERO
    }
...
impl Div<&HVec3> for &HVec3 {
    type Output = HVec3;
    #[inline]
    fn div(self, rhs: &HVec3) -> HVec3 {
        (*self).div(*rhs)
    }
}
...
impl Add<&HVec3> for &HVec3 {
    type Output = HVec3;
    #[inline]
    fn add(self, rhs: &HVec3) -> HVec3 {
        (*self).add(*rhs)
    }
}
...
impl Sub<&HVec3> for &HVec3 {
    type Output = HVec3;
    #[inline]
    fn sub(self, rhs: &HVec3) -> HVec3 {
        (*self).sub(*rhs)
    }
}
...
impl Rem<&HVec3> for &HVec3 {
    type Output = HVec3;
    #[inline]
    fn rem(self, rhs: &HVec3) -> HVec3 {
        (*self).rem(*rhs)
    }
}
...
impl AsRef<[f16; 3]> for HVec3 {
    #[inline]
    fn as_ref(&self) -> &[f16; 3] {
        unsafe { &*(self as *const Self as *const [f16; 3]) }
    }
}

impl AsMut<[f16; 3]> for HVec3 {
    #[inline]
    fn as_mut(&mut self) -> &mut [f16; 3] {
        unsafe { &mut *(self as *mut Self as *mut [f16; 3]) }
    }
}
...
impl<'a> Product<&'a Self> for HVec3 {
    #[inline]
    fn product<I>(iter: I) -> Self
    where
        I: Iterator<Item = &'a Self>,
...
impl fmt::Debug for HVec3 {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        fmt.debug_tuple(stringify!(HVec3))
            .field(&self.x)
            .field(&self.y)
            .field(&self.z)
            .finish()
...
impl From<[f16; 3]> for HVec3 {
    #[inline]
    fn from(a: [f16; 3]) -> Self {
        Self::new(a[0], a[1], a[2])
    }
}

impl From<HVec3> for [f16; 3] {
    #[inline]
    fn from(v: HVec3) -> Self {
        [v.x, v.y, v.z]
    }
}

impl From<(f16, f16, f16)> for HVec3 {
    #[inline]
    fn from(t: (f16, f16, f16)) -> Self {
        Self::new(t.0, t.1, t.2)
    }
}

impl From<HVec3> for (f16, f16, f16) {
    #[inline]
    fn from(v: HVec3) -> Self {
        (v.x, v.y, v.z)
    }
...
impl From<(HVec2, f16)> for HVec3 {
    #[inline]
    fn from((v, z): (HVec2, f16)) -> Self {
        Self::new(v.x, v.y, z)
    }
}
...
#[cfg(feature = "i32")]
impl From<IVec3> for HVec3 {
    #[inline]
    fn from(v: IVec3) -> Self {
        Self::new(
            f16::from_f32(v.x as f32),
            f16::from_f32(v.y as f32),
            f16::from_f32(v.z as f32),
        )
    }
}
...
impl From<BVec3> for HVec3 {
    #[inline]
    fn from(v: BVec3) -> Self {
        Self::new(
            f16::from(u8::from(v.x)),
            f16::from(u8::from(v.y)),
            f16::from(u8::from(v.z)),
        )
    }
}

impl From<BVec3A> for HVec3 {
    #[inline]
    fn from(v: BVec3A) -> Self {
        let bool_array: [bool; 3] = v.into();
        Self::new(
            f16::from(u8::from(bool_array[0])),
            f16::from(u8::from(bool_array[1])),
            f16::from(u8::from(bool_array[2])),
        )
    }
}
