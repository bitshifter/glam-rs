...
impl BitAndAssign for I16Vec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: I16Vec3) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&I16Vec3> for I16Vec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &I16Vec3) {
...
impl BitOrAssign for I16Vec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: I16Vec3) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&I16Vec3> for I16Vec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &I16Vec3) {
...
impl BitXorAssign for I16Vec3 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: I16Vec3) {
...
impl Shl<&crate::IVec3> for I16Vec3 {
    type Output = I16Vec3;
    #[inline]
    fn shl(self, rhs: &crate::IVec3) -> I16Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec3> for I16Vec3 {
    type Output = I16Vec3;
    #[inline]
    fn shr(self, rhs: &crate::IVec3) -> I16Vec3 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec3> for I16Vec3 {
    type Output = I16Vec3;
    #[inline]
    fn shl(self, rhs: &crate::UVec3) -> I16Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec3> for I16Vec3 {
    type Output = I16Vec3;
    #[inline]
    fn shr(self, rhs: &crate::UVec3) -> I16Vec3 {
        self.shr(*rhs)
    }
}
