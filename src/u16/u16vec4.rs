...
impl BitAndAssign for U16Vec4 {
    #[inline]
    fn bitand_assign(&mut self, rhs: U16Vec4) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&U16Vec4> for U16Vec4 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &U16Vec4) {
...
impl BitOrAssign for U16Vec4 {
    #[inline]
    fn bitor_assign(&mut self, rhs: U16Vec4) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&U16Vec4> for U16Vec4 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &U16Vec4) {
...
impl BitXorAssign for U16Vec4 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: U16Vec4) {
...
impl Shl<&crate::IVec4> for U16Vec4 {
    type Output = U16Vec4;
    #[inline]
    fn shl(self, rhs: &crate::IVec4) -> U16Vec4 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec4> for U16Vec4 {
    type Output = U16Vec4;
    #[inline]
    fn shr(self, rhs: &crate::IVec4) -> U16Vec4 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec4> for U16Vec4 {
    type Output = U16Vec4;
    #[inline]
    fn shl(self, rhs: &crate::UVec4) -> U16Vec4 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec4> for U16Vec4 {
    type Output = U16Vec4;
    #[inline]
    fn shr(self, rhs: &crate::UVec4) -> U16Vec4 {
        self.shr(*rhs)
    }
}
