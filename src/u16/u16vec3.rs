...
impl BitAndAssign for U16Vec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: U16Vec3) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&U16Vec3> for U16Vec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &U16Vec3) {
...
impl BitOrAssign for U16Vec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: U16Vec3) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&U16Vec3> for U16Vec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &U16Vec3) {
...
impl BitXorAssign for U16Vec3 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: U16Vec3) {
...
impl Shl<&crate::IVec3> for U16Vec3 {
    type Output = U16Vec3;
    #[inline]
    fn shl(self, rhs: &crate::IVec3) -> U16Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec3> for U16Vec3 {
    type Output = U16Vec3;
    #[inline]
    fn shr(self, rhs: &crate::IVec3) -> U16Vec3 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec3> for U16Vec3 {
    type Output = U16Vec3;
    #[inline]
    fn shl(self, rhs: &crate::UVec3) -> U16Vec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec3> for U16Vec3 {
    type Output = U16Vec3;
    #[inline]
    fn shr(self, rhs: &crate::UVec3) -> U16Vec3 {
        self.shr(*rhs)
    }
}
