...
impl BitAndAssign for I64Vec2 {
    #[inline]
    fn bitand_assign(&mut self, rhs: I64Vec2) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&I64Vec2> for I64Vec2 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &I64Vec2) {
...
impl BitOrAssign for I64Vec2 {
    #[inline]
    fn bitor_assign(&mut self, rhs: I64Vec2) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&I64Vec2> for I64Vec2 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &I64Vec2) {
...
impl BitXorAssign for I64Vec2 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: I64Vec2) {
...
impl Shl<&crate::IVec2> for I64Vec2 {
    type Output = I64Vec2;
    #[inline]
    fn shl(self, rhs: &crate::IVec2) -> I64Vec2 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec2> for I64Vec2 {
    type Output = I64Vec2;
    #[inline]
    fn shr(self, rhs: &crate::IVec2) -> I64Vec2 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec2> for I64Vec2 {
    type Output = I64Vec2;
    #[inline]
    fn shl(self, rhs: &crate::UVec2) -> I64Vec2 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec2> for I64Vec2 {
    type Output = I64Vec2;
    #[inline]
    fn shr(self, rhs: &crate::UVec2) -> I64Vec2 {
        self.shr(*rhs)
    }
}
