...
impl Vec3ASwizzles for Vec3A {
    ...
    fn xxx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.x(), self.0.x()))
        }
    }
    #[inline]
    fn xxy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.x(), self.0.y()))
        }
    }
    #[inline]
    fn xxz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.x(), self.0.z()))
        }
    }
    #[inline]
    fn xyx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.y(), self.0.x()))
        }
    }
    #[inline]
    fn xyy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.y(), self.0.y()))
        }
    }
    #[inline]
    fn xzx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.z(), self.0.x()))
        }
    }
    #[inline]
    fn xzy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.z(), self.0.y()))
        }
    }
    #[inline]
    fn xzz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.x(), self.0.z(), self.0.z()))
        }
    }
    #[inline]
    fn yxx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.x(), self.0.x()))
        }
    }
    #[inline]
    fn yxy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.x(), self.0.y()))
        }
    }
    #[inline]
    fn yxz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.x(), self.0.z()))
        }
    }
    #[inline]
    fn yyx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.y(), self.0.x()))
        }
    }
    #[inline]
    fn yyy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.y(), self.0.y()))
        }
    }
    #[inline]
    fn yyz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.y(), self.0.z()))
        }
    }
    #[inline]
    fn yzx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.z(), self.0.x()))
        }
    }
    #[inline]
    fn yzy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.z(), self.0.y()))
        }
    }
    #[inline]
    fn yzz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.y(), self.0.z(), self.0.z()))
        }
    }
    #[inline]
    fn zxx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.x(), self.0.x()))
        }
    }
    #[inline]
    fn zxy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.x(), self.0.y()))
        }
    }
    #[inline]
    fn zxz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.x(), self.0.z()))
        }
    }
    #[inline]
    fn zyx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.y(), self.0.x()))
        }
    }
    #[inline]
    fn zyy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.y(), self.0.y()))
        }
    }
    #[inline]
    fn zyz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.y(), self.0.z()))
        }
    }
    #[inline]
    fn zzx(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.z(), self.0.x()))
        }
    }
    #[inline]
    fn zzy(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.z(), self.0.y()))
        }
    }
    #[inline]
    fn zzz(self) -> Vec3A {
        ...
        #[cfg(vec3a_f32)]
        {
            Vec3A(Vec3(self.0.z(), self.0.z(), self.0.z()))
        }
    }
    #[inline]
    fn xx(self) -> Vec2 {
