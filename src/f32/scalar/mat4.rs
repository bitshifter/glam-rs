...
use crate::{
    ...
    DMat4, EulerRot, Mat3, Quat, Vec3, Vec3A, Vec4,
};
...
impl Mat4 {
    ...
    pub fn from_cols_array(m: &[f32; 16]) -> Self {
        Self(Columns4::<XYZW<f32>>::from_cols_array(m))
    }
    ...
    pub fn from_cols_array_2d(m: &[[f32; 4]; 4]) -> Self {
        Self(Columns4::<XYZW<f32>>::from_cols_array_2d(m))
    }
    ...
    pub fn from_diagonal(diagonal: Vec4) -> Self {
        ...
        Self(Columns4::<XYZW<f32>>::from_diagonal(diagonal.0.into()))
    }
    ...
    pub fn from_scale_rotation_translation(scale: Vec3, rotation: Quat, translation: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::from_scale_quaternion_translation(
            scale.0,
            rotation.0,
            translation.0,
        ))
    ...
    pub fn from_rotation_translation(rotation: Quat, translation: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::from_quaternion_translation(
            rotation.0,
            translation.0,
        ))
    }
    ...
    pub fn from_quat(rotation: Quat) -> Self {
        Self(Columns4::<XYZW<f32>>::from_quaternion(rotation.0))
    }
    ...
    pub fn from_translation(translation: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::from_translation(translation.0))
    }
    ...
    pub fn from_axis_angle(axis: Vec3, angle: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::from_axis_angle(axis.0, angle))
    }
    ...
    pub fn from_rotation_x(angle: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::from_rotation_x(angle))
    }
    ...
    pub fn from_rotation_y(angle: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::from_rotation_y(angle))
    }
    ...
    pub fn from_rotation_z(angle: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::from_rotation_z(angle))
    }
    ...
    pub fn from_scale(scale: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::from_scale(scale.0))
    }
    ...
    pub fn from_cols_slice(slice: &[f32]) -> Self {
        Self(Columns4::<XYZW<f32>>::from_cols_slice(slice))
    }
    ...
    pub fn write_cols_to_slice(self, slice: &mut [f32]) {
        Columns4::<XYZW<f32>>::write_cols_to_slice(&self.0, slice)
    }
    ...
    pub fn look_at_lh(eye: Vec3, center: Vec3, up: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::look_at_lh(eye.0, center.0, up.0))
    }
    ...
    pub fn look_at_rh(eye: Vec3, center: Vec3, up: Vec3) -> Self {
        Self(Columns4::<XYZW<f32>>::look_at_rh(eye.0, center.0, up.0))
    }
    ...
    pub fn perspective_rh_gl(
        ...
        Self(Columns4::<XYZW<f32>>::perspective_rh_gl(
            fov_y_radians,
            aspect_ratio,
            z_near,
            z_far,
    ...
    pub fn perspective_lh(fov_y_radians: f32, aspect_ratio: f32, z_near: f32, z_far: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::perspective_lh(
            fov_y_radians,
            aspect_ratio,
            z_near,
            z_far,
    ...
    pub fn perspective_rh(fov_y_radians: f32, aspect_ratio: f32, z_near: f32, z_far: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::perspective_rh(
            fov_y_radians,
            aspect_ratio,
            z_near,
            z_far,
    ...
    pub fn perspective_infinite_lh(fov_y_radians: f32, aspect_ratio: f32, z_near: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::perspective_infinite_lh(
            fov_y_radians,
            aspect_ratio,
            z_near,
        ))
    ...
    pub fn perspective_infinite_reverse_lh(
        ...
        Self(Columns4::<XYZW<f32>>::perspective_infinite_reverse_lh(
            fov_y_radians,
            aspect_ratio,
            z_near,
        ))
    ...
    pub fn perspective_infinite_rh(fov_y_radians: f32, aspect_ratio: f32, z_near: f32) -> Self {
        Self(Columns4::<XYZW<f32>>::perspective_infinite_rh(
            fov_y_radians,
            aspect_ratio,
            z_near,
        ))
    ...
    pub fn perspective_infinite_reverse_rh(
        ...
        Self(Columns4::<XYZW<f32>>::perspective_infinite_reverse_rh(
            fov_y_radians,
            aspect_ratio,
            z_near,
        ))
    ...
    pub fn orthographic_rh_gl(
        ...
        Self(Columns4::<XYZW<f32>>::orthographic_rh_gl(
    ...
    pub fn orthographic_lh(
        ...
        Self(Columns4::<XYZW<f32>>::orthographic_lh(
            left, right, bottom, top, near, far,
        ))
    }
    ...
    pub fn orthographic_rh(
        ...
        Self(Columns4::<XYZW<f32>>::orthographic_rh(
            left, right, bottom, top, near, far,
        ))
    }
