...
pub struct Vec4(pub(crate) XYZW<f32>);

impl Vec4 {
    /// All zeroes.
    pub const ZERO: Self = Self(XYZW::<f32>::ZERO);

    /// All ones.
    pub const ONE: Self = Self(XYZW::<f32>::ONE);
    ...
    pub const X: Self = Self(<XYZW<f32> as Vector4Const>::X);

    /// `[0, 1, 0, 0]`: a unit-length vector pointing along the positive Y axis.
    pub const Y: Self = Self(<XYZW<f32> as Vector4Const>::Y);

    /// `[0, 0, 1, 0]`: a unit-length vector pointing along the positive Z axis.
    pub const Z: Self = Self(<XYZW<f32> as Vector4Const>::Z);

    /// `[0, 0, 0, 1]`: a unit-length vector pointing along the positive W axis.
    pub const W: Self = Self(<XYZW<f32> as Vector4Const>::W);
    ...
    pub fn select(mask: BVec4, if_true: Self, if_false: Self) -> Self {
        Self(XYZW::<f32>::select(mask.0, if_true.0, if_false.0))
    }

    /// Computes the dot product of `self` and `other`.
    #[inline(always)]
    pub fn dot(self, other: Self) -> f32 {
        <XYZW<f32> as Vector4<f32>>::dot(self.0, other.0)
    }
    ...
    pub fn clamp(self, min: Self, max: Self) -> Self {
        Self(<XYZW<f32> as Vector4<f32>>::clamp(self.0, min.0, max.0))
    }
    ...
    pub fn min_element(self) -> f32 {
        <XYZW<f32> as Vector4<f32>>::min_element(self.0)
    }
    ...
    pub fn max_element(self) -> f32 {
        <XYZW<f32> as Vector4<f32>>::max_element(self.0)
    }
    ...
    pub fn from_slice(slice: &[f32]) -> Self {
        Self(<XYZW<f32> as Vector4<f32>>::from_slice_unaligned(slice))
    }
    ...
    pub fn write_to_slice(self, slice: &mut [f32]) {
        <XYZW<f32> as Vector4<f32>>::write_to_slice_unaligned(self.0, slice)
    }

    /// Returns a vector containing the absolute value of each element of `self`.
    #[inline(always)]
    pub fn abs(self) -> Self {
        Self(<XYZW<f32> as SignedVector4<f32>>::abs(self.0))
    }
    ...
    pub fn signum(self) -> Self {
        Self(<XYZW<f32> as SignedVector4<f32>>::signum(self.0))
    }
...
impl Div<Vec4> for f32 {
    ...
    fn div(self, other: Vec4) -> Vec4 {
        Vec4(XYZW::<f32>::splat(self).div(other.0))
    }
}
...
impl Mul<Vec4> for f32 {
    ...
    fn mul(self, other: Vec4) -> Vec4 {
        Vec4(XYZW::<f32>::splat(self).mul(other.0))
    }
}
...
impl Add<Vec4> for f32 {
    ...
    fn add(self, other: Vec4) -> Vec4 {
        Vec4(XYZW::<f32>::splat(self).add(other.0))
    }
}
...
impl Sub<Vec4> for f32 {
    ...
    fn sub(self, other: Vec4) -> Vec4 {
        Vec4(XYZW::<f32>::splat(self).sub(other.0))
    }
}
...
impl Rem<Vec4> for f32 {
    ...
    fn rem(self, other: Vec4) -> Vec4 {
        Vec4(XYZW::<f32>::splat(self).rem(other.0))
    }
}
...
impl From<XYZW<f32>> for Vec4 {
    #[inline(always)]
    fn from(t: XYZW<f32>) -> Self {
        Self(t)
    }
}
...
impl From<[f32; 4]> for Vec4 {
    ...
    fn from(a: [f32; 4]) -> Self {
        Self(<XYZW<f32> as Vector4<f32>>::from_array(a))
    }
}
...
impl From<(f32, f32, f32, f32)> for Vec4 {
    ...
    fn from(t: (f32, f32, f32, f32)) -> Self {
        Self(<XYZW<f32> as Vector4<f32>>::from_tuple(t))
    }
}
