...
impl Vec4 {
    ...
    pub fn dot(self, other: Self) -> f32 {
        <__m128 as Vector4<f32>>::dot(self.0, other.0)
    }
    ...
    pub fn clamp(self, min: Self, max: Self) -> Self {
        Self(<__m128 as Vector4<f32>>::clamp(self.0, min.0, max.0))
    }
    ...
    pub fn min_element(self) -> f32 {
        <__m128 as Vector4<f32>>::min_element(self.0)
    }
    ...
    pub fn max_element(self) -> f32 {
        <__m128 as Vector4<f32>>::max_element(self.0)
    }
    ...
    pub fn from_slice(slice: &[f32]) -> Self {
        Self(<__m128 as Vector4<f32>>::from_slice_unaligned(slice))
    }
    ...
    pub fn write_to_slice(self, slice: &mut [f32]) {
        <__m128 as Vector4<f32>>::write_to_slice_unaligned(self.0, slice)
    }

    /// Returns a vector containing the absolute value of each element of `self`.
    #[inline(always)]
    pub fn abs(self) -> Self {
        Self(<__m128 as SignedVector4<f32>>::abs(self.0))
    }
    ...
    pub fn signum(self) -> Self {
        Self(<__m128 as SignedVector4<f32>>::signum(self.0))
    }
...
impl Div<Vec4> for f32 {
    ...
    fn div(self, other: Vec4) -> Vec4 {
        Vec4(__m128::splat(self).div(other.0))
    }
}
...
impl Mul<Vec4> for f32 {
    ...
    fn mul(self, other: Vec4) -> Vec4 {
        Vec4(__m128::splat(self).mul(other.0))
    }
}
...
impl Add<Vec4> for f32 {
    ...
    fn add(self, other: Vec4) -> Vec4 {
        Vec4(__m128::splat(self).add(other.0))
    }
}
...
impl Sub<Vec4> for f32 {
    ...
    fn sub(self, other: Vec4) -> Vec4 {
        Vec4(__m128::splat(self).sub(other.0))
    }
}
...
impl Rem<Vec4> for f32 {
    ...
    fn rem(self, other: Vec4) -> Vec4 {
        Vec4(__m128::splat(self).rem(other.0))
    }
}
...
impl From<[f32; 4]> for Vec4 {
    ...
    fn from(a: [f32; 4]) -> Self {
        Self(<__m128 as Vector4<f32>>::from_array(a))
    }
}
...
impl From<(f32, f32, f32, f32)> for Vec4 {
    ...
    fn from(t: (f32, f32, f32, f32)) -> Self {
        Self(<__m128 as Vector4<f32>>::from_tuple(t))
    }
}
