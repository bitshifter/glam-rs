...
pub struct Vec2(pub(crate) XY<f32>);

impl Vec2 {
    /// All zeroes.
    pub const ZERO: Self = Self(XY::<f32>::ZERO);

    /// All ones.
    pub const ONE: Self = Self(XY::<f32>::ONE);

    /// All NAN.
    pub const NAN: Self = Self(<XY<f32> as crate::core::traits::scalar::NanConstEx>::NAN);

    /// `[1, 0]`: a unit-length vector pointing along the positive X axis.
    pub const X: Self = Self(<XY<f32> as Vector2Const>::X);

    /// `[0, 1]`: a unit-length vector pointing along the positive Y axis.
    pub const Y: Self = Self(<XY<f32> as Vector2Const>::Y);
    ...
    pub fn select(mask: BVec2, if_true: Self, if_false: Self) -> Self {
        Self(XY::<f32>::select(mask.0, if_true.0, if_false.0))
    }

    /// Computes the dot product of `self` and `other`.
    #[inline(always)]
    pub fn dot(self, other: Self) -> f32 {
        <XY<f32> as Vector2<f32>>::dot(self.0, other.0)
    }
    ...
    pub fn clamp(self, min: Self, max: Self) -> Self {
        Self(<XY<f32> as Vector2<f32>>::clamp(self.0, min.0, max.0))
    }
    ...
    pub fn min_element(self) -> f32 {
        <XY<f32> as Vector2<f32>>::min_element(self.0)
    }
    ...
    pub fn max_element(self) -> f32 {
        <XY<f32> as Vector2<f32>>::max_element(self.0)
    }
    ...
    pub fn from_slice(slice: &[f32]) -> Self {
        Self(<XY<f32> as Vector2<f32>>::from_slice_unaligned(slice))
    }
    ...
    pub fn write_to_slice(self, slice: &mut [f32]) {
        <XY<f32> as Vector2<f32>>::write_to_slice_unaligned(self.0, slice)
    }

    /// Returns a vector containing the absolute value of each element of `self`.
    #[inline(always)]
    pub fn abs(self) -> Self {
        Self(<XY<f32> as SignedVector2<f32>>::abs(self.0))
    }
    ...
    pub fn signum(self) -> Self {
        Self(<XY<f32> as SignedVector2<f32>>::signum(self.0))
    }
...
impl Div<Vec2> for f32 {
    ...
    fn div(self, other: Vec2) -> Vec2 {
        Vec2(XY::<f32>::splat(self).div(other.0))
    }
}
...
impl Mul<Vec2> for f32 {
    ...
    fn mul(self, other: Vec2) -> Vec2 {
        Vec2(XY::<f32>::splat(self).mul(other.0))
    }
}
...
impl Add<Vec2> for f32 {
    ...
    fn add(self, other: Vec2) -> Vec2 {
        Vec2(XY::<f32>::splat(self).add(other.0))
    }
}
...
impl Sub<Vec2> for f32 {
    ...
    fn sub(self, other: Vec2) -> Vec2 {
        Vec2(XY::<f32>::splat(self).sub(other.0))
    }
}
...
impl Rem<Vec2> for f32 {
    ...
    fn rem(self, other: Vec2) -> Vec2 {
        Vec2(XY::<f32>::splat(self).rem(other.0))
    }
}
...
impl From<[f32; 2]> for Vec2 {
    ...
    fn from(a: [f32; 2]) -> Self {
        Self(<XY<f32> as Vector2<f32>>::from_array(a))
    }
}
...
impl From<(f32, f32)> for Vec2 {
    ...
    fn from(t: (f32, f32)) -> Self {
        Self(<XY<f32> as Vector2<f32>>::from_tuple(t))
    }
}
