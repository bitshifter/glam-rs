...
impl BitAndAssign for IVec3 {
    #[inline]
    fn bitand_assign(&mut self, rhs: IVec3) {
...
impl BitOrAssign for IVec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: IVec3) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&IVec3> for IVec3 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &IVec3) {
...
impl BitXorAssign for IVec3 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: IVec3) {
...
impl Shl<&crate::IVec3> for IVec3 {
    type Output = IVec3;
    #[inline]
    fn shl(self, rhs: &crate::IVec3) -> IVec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec3> for IVec3 {
    type Output = IVec3;
    #[inline]
    fn shr(self, rhs: &crate::IVec3) -> IVec3 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec3> for IVec3 {
    type Output = IVec3;
    #[inline]
    fn shl(self, rhs: &crate::UVec3) -> IVec3 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec3> for IVec3 {
    type Output = IVec3;
    #[inline]
    fn shr(self, rhs: &crate::UVec3) -> IVec3 {
        self.shr(*rhs)
    }
}
