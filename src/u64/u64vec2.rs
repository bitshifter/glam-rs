...
use crate::{BVec2, I16Vec2, I64Vec2, I8Vec2, IVec2, U16Vec2, U64Vec3, U8Vec2, USizeVec2, UVec2};
...
impl BitAndAssign for U64Vec2 {
    #[inline]
    fn bitand_assign(&mut self, rhs: U64Vec2) {
        *self = self.bitand(rhs);
    }
}

impl BitAndAssign<&U64Vec2> for U64Vec2 {
    #[inline]
    fn bitand_assign(&mut self, rhs: &U64Vec2) {
...
impl BitOrAssign for U64Vec2 {
    #[inline]
    fn bitor_assign(&mut self, rhs: U64Vec2) {
        *self = self.bitor(rhs);
    }
}

impl BitOrAssign<&U64Vec2> for U64Vec2 {
    #[inline]
    fn bitor_assign(&mut self, rhs: &U64Vec2) {
...
impl BitXorAssign for U64Vec2 {
    #[inline]
    fn bitxor_assign(&mut self, rhs: U64Vec2) {
...
impl Shl<&crate::IVec2> for U64Vec2 {
    type Output = U64Vec2;
    #[inline]
    fn shl(self, rhs: &crate::IVec2) -> U64Vec2 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::IVec2> for U64Vec2 {
    type Output = U64Vec2;
    #[inline]
    fn shr(self, rhs: &crate::IVec2) -> U64Vec2 {
        self.shr(*rhs)
    }
}
...
impl Shl<&crate::UVec2> for U64Vec2 {
    type Output = U64Vec2;
    #[inline]
    fn shl(self, rhs: &crate::UVec2) -> U64Vec2 {
        self.shl(*rhs)
    }
}
...
impl Shr<&crate::UVec2> for U64Vec2 {
    type Output = U64Vec2;
    #[inline]
    fn shr(self, rhs: &crate::UVec2) -> U64Vec2 {
        self.shr(*rhs)
    }
}
