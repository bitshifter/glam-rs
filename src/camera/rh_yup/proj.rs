...
pub mod opengl {
    ...
    ///
    /// Expects a right-handed view space.
    ///
    ...
    pub fn perspective(vertical_fov: f32, aspect_ratio: f32, z_near: f32, z_far: f32) -> Mat4 {
        camera_impl::perspective::<true, false, false>(vertical_fov, aspect_ratio, z_near, z_far)
    }
...
pub mod vulkan {
    ...
    #[must_use]
    pub fn perspective(vertical_fov: f32, aspect_ratio: f32, z_near: f32, z_far: f32) -> Mat4 {
        camera_impl::perspective::<true, true, true>(vertical_fov, aspect_ratio, z_near, z_far)
    }
    ...
    #[inline]
    #[must_use]
    pub fn perspective_infinite_z(vertical_fov: f32, aspect_ratio: f32, z_near: f32) -> Mat4 {
...
pub mod directx {
    ...
    #[must_use]
    pub fn perspective(vertical_fov: f32, aspect_ratio: f32, z_near: f32, z_far: f32) -> Mat4 {
        camera_impl::perspective::<true, true, false>(vertical_fov, aspect_ratio, z_near, z_far)
    }
