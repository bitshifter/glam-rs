...
pub struct DVec4(pub(crate) XYZW<f64>);

impl DVec4 {
    /// All zeroes.
    pub const ZERO: Self = Self(XYZW::<f64>::ZERO);

    /// All ones.
    pub const ONE: Self = Self(XYZW::<f64>::ONE);
    ...
    pub const X: Self = Self(<XYZW<f64> as Vector4Const>::X);

    /// `[0, 1, 0, 0]`: a unit-length vector pointing along the positive Y axis.
    pub const Y: Self = Self(<XYZW<f64> as Vector4Const>::Y);

    /// `[0, 0, 1, 0]`: a unit-length vector pointing along the positive Z axis.
    pub const Z: Self = Self(<XYZW<f64> as Vector4Const>::Z);

    /// `[0, 0, 0, 1]`: a unit-length vector pointing along the positive W axis.
    pub const W: Self = Self(<XYZW<f64> as Vector4Const>::W);
    ...
    pub fn select(mask: BVec4, if_true: Self, if_false: Self) -> Self {
        Self(XYZW::<f64>::select(mask.0, if_true.0, if_false.0))
    }

    /// Computes the dot product of `self` and `other`.
    #[inline(always)]
    pub fn dot(self, other: Self) -> f64 {
        <XYZW<f64> as Vector4<f64>>::dot(self.0, other.0)
    }
    ...
    pub fn clamp(self, min: Self, max: Self) -> Self {
        Self(<XYZW<f64> as Vector4<f64>>::clamp(self.0, min.0, max.0))
    }
    ...
    pub fn min_element(self) -> f64 {
        <XYZW<f64> as Vector4<f64>>::min_element(self.0)
    }
    ...
    pub fn max_element(self) -> f64 {
        <XYZW<f64> as Vector4<f64>>::max_element(self.0)
    }
    ...
    pub fn from_slice(slice: &[f64]) -> Self {
        Self(<XYZW<f64> as Vector4<f64>>::from_slice_unaligned(slice))
    }
    ...
    pub fn write_to_slice(self, slice: &mut [f64]) {
        <XYZW<f64> as Vector4<f64>>::write_to_slice_unaligned(self.0, slice)
    }

    /// Returns a vector containing the absolute value of each element of `self`.
    #[inline(always)]
    pub fn abs(self) -> Self {
        Self(<XYZW<f64> as SignedVector4<f64>>::abs(self.0))
    }
    ...
    pub fn signum(self) -> Self {
        Self(<XYZW<f64> as SignedVector4<f64>>::signum(self.0))
    }
    ...
    pub fn is_nan_mask(self) -> BVec4 {
        BVec4(FloatVector4::is_nan_mask(self.0))
    }
...
impl Div<DVec4> for f64 {
    type Output = DVec4;
    #[inline(always)]
    fn div(self, other: DVec4) -> DVec4 {
        DVec4(XYZW::<f64>::splat(self).div(other.0))
    }
}
...
impl Mul<DVec4> for f64 {
    ...
    fn mul(self, other: DVec4) -> DVec4 {
        DVec4(XYZW::<f64>::splat(self).mul(other.0))
    }
}
...
impl Add<DVec4> for f64 {
    type Output = DVec4;
    #[inline(always)]
    fn add(self, other: DVec4) -> DVec4 {
        DVec4(XYZW::<f64>::splat(self).add(other.0))
    }
}
...
impl Sub<DVec4> for f64 {
    type Output = DVec4;
    #[inline(always)]
    fn sub(self, other: DVec4) -> DVec4 {
        DVec4(XYZW::<f64>::splat(self).sub(other.0))
    }
}
...
impl RemAssign<DVec4> for DVec4 {
    #[inline(always)]
    fn rem_assign(&mut self, other: DVec4) {
...
impl Rem<DVec4> for f64 {
    type Output = DVec4;
    #[inline(always)]
    fn rem(self, other: DVec4) -> DVec4 {
        DVec4(XYZW::<f64>::splat(self).rem(other.0))
    }
}
...
impl From<DVec4> for XYZW<f64> {
    #[inline(always)]
    fn from(t: DVec4) -> Self {
        t.0
    }
}

impl From<XYZW<f64>> for DVec4 {
    #[inline(always)]
    fn from(t: XYZW<f64>) -> Self {
        Self(t)
    }
}
...
impl From<[f64; 4]> for DVec4 {
    ...
    fn from(a: [f64; 4]) -> Self {
        Self(<XYZW<f64> as Vector4<f64>>::from_array(a))
    }
}
...
impl From<(f64, f64, f64, f64)> for DVec4 {
    ...
    fn from(t: (f64, f64, f64, f64)) -> Self {
        Self(<XYZW<f64> as Vector4<f64>>::from_tuple(t))
    }
}
